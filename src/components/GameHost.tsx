...
export const GameHost = () => {
  ...
  return <div className="space-y-6">
      ...
      {/* Ready State */}
      {gameState === 'waiting' && !gameReady && <Card className="p-8 bg-gradient-to-br from-yellow-600 to-yellow-800 shadow-float text-center border-4 border-black bg-amber-400">
